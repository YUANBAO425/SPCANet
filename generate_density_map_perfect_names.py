...
#        num_img = 300 if is_train else 182
 ...
 #       num_img = 400 if is_train else 316
  ...
  #      num_img = 1201 if is_train else 334
        image_dir_path = "/root/autodl-tmp/UCF-QNRF_ECCV18/" +"train" + "/images"
        ground_truth_dir_path = "/root/autodl-tmp/UCF-QNRF_ECCV18/" +"train" + "/ground_truth"
        output_den_path = "/root/autodl-tmp/UCF-QNRF_ECCV18/" + train_test_for_den
        # two extra paths
        output_img_path = "/root/autodl-tmp/UCF-QNRF_ECCV18/ori/" + "train_data" + "/images" # using `gt_SH` here
        output_mat_path = "/root/autodl-tmp/UCF-QNRF_ECCV18/ori/" + "train_data" + "/ground_truth"
        ...
        output_den_path = "./UCF50/" + train_test_for_den
        output_img_path = "./UCF50/ori/" + train_test_for_gt_SH + "/images"
        output_mat_path = './UCF50/ori/' + train_test_for_gt_SH + "/ground_truth"
